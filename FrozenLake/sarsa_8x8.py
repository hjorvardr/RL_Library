...
np.save('sarsa_8x8_policy.npy', learnt_policy)
#print("Policy learnt: ", learnt_policy)

# np.savetxt("results/training/sarsa_8x8.csv", train_res["scores"], delimiter=',')

# Testing
test_agent = np.load('sarsa_8x8_policy.npy')
...
# np.savetxt("results/testing/sarsa_8x8.csv", test_res["scores"], delimiter=',')

...
np.save('ql_8x8d_policy.npy', learnt_policy)
#print("Policy learnt: ", learnt_policy)

# np.savetxt("results/training/ql_8x8_deterministic.csv", train_res["scores"], delimiter=',')

# Testing
test_agent = np.load('ql_8x8d_policy.npy')
...
# np.savetxt("results/testing/ql_8x8_deterministic.csv", test_res["scores"], delimiter=',')
